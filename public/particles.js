window.onload= function() {
  ...
  Particles.prototype.render = function(){ 
    var self = this,
        wHeight = $(window).height()/1,
        wWidth = $(window).width()/0.5;
  ...
  Particles.prototype.animate = function(particle){
    ...
    setInterval(function(){
      ...
      for (var i = 0; i < self.numParticles; i++) {
        ...
        if (particle[i].xPos > self.canvas.width + particle[i].radius || particle[i].yPos > self.canvas.height + particle[i].radius || particle[i].yPos < 0-particle[i].radius) {
